...
public class SecondActivity extends AppCompatActivity {
	...
	public void loadAccountData(View view) {
		// com.sriyanksiddhartha.sharedpreferences.my_pref_file
		// get SharedPreferences at application level
		// name will be: <package>.file_name.xml
		// "com.sriyanksiddhartha.sharedpreferences.my_pref_file.xml"

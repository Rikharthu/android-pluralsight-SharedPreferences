...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Load Data from Activity Level SharedPrefs (separate preferences file for this activity)
		/* getPreferences returns preferences file that is only for current activity
		 this will be the only preferences file for this Activity, since we do not supply a name */
		SharedPreferences sharedPreferences = getPreferences(Context.MODE_PRIVATE);
        // filename will be "<activity name>.xml" => "MainActivity.xml"
	...
	// Executed when save button clicked
	...
	public void loadAccountData(View view) {
        ...
        // Load data from Application Level SharedPrefs
		SharedPreferences sharedPreferences = getSharedPreferences(getPackageName() + Constants.PREF_FILE_NAME, Context.MODE_PRIVATE);
